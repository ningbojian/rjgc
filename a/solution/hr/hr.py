...
lab_1 = tk.Label(window, text="请输入初始状态(从左至右，从上到下，如：102345678)：").grid(row=1,column=1)
En1 = tk.Entry(window)
lab_2 = tk.Label(window, text="请输入目标状态(从左至右，从上到下，如：123456780)：").grid(row=2,column=1)
En2 = tk.Entry(window)
b1 = tk.Button(window, text = '计算', command=click_1).grid(row = 3, column=1)
b2 = tk.Button(window, text = '展示解题步骤', command=click_2).grid(row = 4, column=1)
En1.grid(row=1, column=2, ipady=5)
En2.grid(row=2, column=2, ipady=5)
